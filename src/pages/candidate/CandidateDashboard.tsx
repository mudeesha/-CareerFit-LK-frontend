...
} from "../../services/candidateDashboardApi";
...
export function CandidateDashboard() {
  ...
  if (!dashboard) {
    return <div className="text-gray-600">No dashboard data found.</div>;
  }
  ...
  const skillGapInsights = dashboard.skillGapInsights ?? [];
      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
        <div className="bg-[#F3F4F6] border border-gray-200 rounded-2xl p-5">
          ...
          <div className="text-2xl font-bold text-gray-900">
            {dashboard.stats.profileCompletion}%
          </div>
        </div>
        ...
        <div className="lg:col-span-2 space-y-8">
          <div>
            ...
            {recommendedJobs.length === 0 ? (
              <div className="bg-[#F3F4F6] border border-gray-200 rounded-[16px] p-5 text-sm text-gray-500">
          ...
          <div className="bg-[#F3F4F6] border border-gray-200 rounded-[16px] p-6">
            ...
            {skillGapInsights.length === 0 ? (
              <p className="text-sm text-gray-500">
                No skill gap insights available yet.
              </p>
            ) : (
            ...
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                <h3 className="font-bold text-purple-900">
                  Profile is {dashboard.stats.profileCompletion}% complete
                </h3>
